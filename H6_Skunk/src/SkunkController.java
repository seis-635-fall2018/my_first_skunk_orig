...
public class SkunkController {
	...
	public boolean run() {
		...
		activePlayer = getFirstPlayer(players);
	...
	public Player getFirstPlayer(ArrayList<Player> players) {
		activePlayerIndex = 0;
	...
	public void scoreSkunkRoll(Player player, int chipsLost) {
		kitty += chipsLost;
		player.setNumberChips(player.getNumberChips() - chipsLost);
